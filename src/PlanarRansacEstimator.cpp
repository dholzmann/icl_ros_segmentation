...
Mat_<PlanarRansacEstimator::Result> PlanarRansacEstimator::apply(Mat &xyzh,
...
void PlanarRansacEstimator::calculateMultiCL(Mat &xyzh, Mat labelImage, Mat &testMatrix, float threshold, int passes,
...
void PlanarRansacEstimator::calculateSingleCL(std::vector<Vec4f> &dstPoints, float threshold, int passes, int subset,
            std::vector<Vec4f> &n0, std::vector<float> &dist, std::vector<int> &cAbove, std::vector<int> &cBelow, std::vector<int> &cOn){
...
Mat_<PlanarRansacEstimator::Result> PlanarRansacEstimator::createResultMatrix(Mat &testMatrix, std::vector<int> &start,
  ...
  Result init;
  Mat_<Result> result(testMatrix.size(), init);
...
void PlanarRansacEstimator::relabelCL(Mat &xyzh, Mat &newMask, Mat &oldLabel, Mat &newLabel,
